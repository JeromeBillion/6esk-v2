...
const tenantId = JOBS_RUNNER_TENANT_ID || CALLS_OUTBOX_TENANT_ID || WHATSAPP_OUTBOX_TENANT_ID || INBOUND_TENANT_ID || "";

if (!APP_URL || !secret || !tenantId) {
  console.error("APP_URL, JOBS_RUNNER_SECRET (or CALLS_OUTBOX_SECRET/WHATSAPP_OUTBOX_SECRET/INBOUND_SHARED_SECRET), and JOBS_RUNNER_TENANT_ID (or CALLS_OUTBOX_TENANT_ID/WHATSAPP_OUTBOX_TENANT_ID/INBOUND_TENANT_ID) are required");
  process.exit(1);
}
