...
- tag catalogs, ticket-tag joins, merge-review tasks, support macros, saved views, password reset state, SLA analytics, overview analytics, and voice consent history now carry tenant ownership and have regression coverage in `npm run test:tenant-isolation`
