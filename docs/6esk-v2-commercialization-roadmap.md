...
- tag catalogs, ticket-tag joins, merge-review tasks, support macros, saved views, password reset state, SLA analytics, overview analytics, voice consent history, and voice operator presence now carry tenant ownership and have regression coverage in `npm run test:tenant-isolation`
