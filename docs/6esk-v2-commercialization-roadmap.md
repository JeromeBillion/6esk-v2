...
- AI follow-through: lane queue observability/recovery/dead-letter hardening, policy pipeline, actual runtime tool-call policy/ledger population, tenant-safe RAG runtime integration, stronger prompt-injection evals, vetted binary extraction/malware scanning, and rollout evidence while preserving native Dexter and v2 runtime files
