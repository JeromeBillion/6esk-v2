...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    gl.canvas.className = styles.auroraCanvas;
    ...
    const render = (timestamp: number) => {
      ...
      const nextTime = propsRef.current.time ?? timestamp * 0.001;
      ...
      program.uniforms.uColorStops.value = toColorStops(propsRef.current.colorStops);
